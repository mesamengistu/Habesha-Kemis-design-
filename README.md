...
## Output for single image projection
![Teaser image](./docs/projectedimage.PNG)
## Output from random seed value
![Teaser image](./docs/outputfromrandomseedvalue.PNG)
